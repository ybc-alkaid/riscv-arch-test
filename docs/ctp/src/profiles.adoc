...
* MC100 Microcontroller Profile (https://riscv.github.io/riscv-arch-test/crd/mc100_crd.html[MC100-32-CRD.pdf]): Phase 1
...
* RVA23 Profile (https://riscv.github.io/riscv-unified-db/pdfs/AC200-CRD.pdf[AC200 CRD]): Phase 2
