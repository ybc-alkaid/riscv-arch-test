...
TODO: reconcile this with CRD that illegal values are not supported for WARL fields.
Parameters are needed to specify the illegal values for a DUT.  The reference model
could read these parameters, and then the tests could exercise all values and match
the reference model.  Should there be discretion about what to do?
riscv.github.io/riscv-unified-db/pdfs/RVI20-32-CRD.pdf
