...
`define COVER_ZVKNHB32
`define COVER_ZVKNHBCUSTOM32
`ifdef UDB_ELEN_32
...
`endif
covergroup Zvknhb32_vsha2ch_vv_cg with function sample(ins_t ins);
...
endgroup
// ---------------------
covergroup Zvknhb32_vsha2cl_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2_egs4
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvknhb32_vsha2ms_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2_egs4
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
function void zvknhb32_sample(int hart, int issue, ins_t ins);
    ...
    if (get_csr_val(hart, issue, `SAMPLE_BEFORE, "vtype", "vsew") == 2 ||
        ...
        "vsha2ch.vv"     : begin
            Zvknhb32_vsha2ch_vv_cg.sample(ins);
        end
        "vsha2cl.vv"     : begin
            Zvknhb32_vsha2cl_vv_cg.sample(ins);
        end
        "vsha2ms.vv"     : begin
            Zvknhb32_vsha2ms_vv_cg.sample(ins);
        end
        endcase
    end
endfunction
