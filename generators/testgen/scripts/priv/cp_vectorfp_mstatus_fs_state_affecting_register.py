"""Priv coverpoint handler for cp_vectorfp_mstatus_fs_state_affecting_register.
...
CP = "cp_vectorfp_mstatus_fs_state_affecting_register"


@register(CP)
def make_vectorfp_mstatus_fs_state_affecting_register(instruction: str) -> None:
